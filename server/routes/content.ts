/**
 * Registers content, about-page, and content-registry HTTP routes.
 * Reads: Express requests and the configured storage adapter; writes: storage mutations and JSON responses.
 */

import { Router, Request, Response } from 'express';
import type { StorageAdapter, ContentType } from '../storage/adapter.js';

const getRouteParam = (value: string | string[]): string => Array.isArray(value) ? value[0] ?? '' : value;

export function registerContentRoutes(router: Router, storage: StorageAdapter): void {
